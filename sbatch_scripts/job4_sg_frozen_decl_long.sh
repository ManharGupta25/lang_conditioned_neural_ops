#!/bin/bash
#SBATCH --job-name=sg_frozen_decl_long
#SBATCH --partition=goodarzilab_gpu_priority,gpu_batch_high_mem,gpu_batch
#SBATCH --gres=gpu:1
#SBATCH --mem=100G
#SBATCH --cpus-per-task=16
#SBATCH --output=slurm_logs/job4_sg_frozen_decl_long_%j.out
#SBATCH --error=slurm_logs/job4_sg_frozen_decl_long_%j.err
#SBATCH --time=12:00:00

# ── Job 4: spectral_gating, frozen trunk, declarative_long control ──
# All 6 PDEs, max_length=512, text same as declarative baseline.
