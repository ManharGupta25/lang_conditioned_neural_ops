#!/bin/bash
#SBATCH --job-name=sg_joint_decl_long
#SBATCH --partition=goodarzilab_gpu_priority,gpu_batch_high_mem,gpu_batch
#SBATCH --gres=gpu:1
#SBATCH --mem=100G
#SBATCH --cpus-per-task=16
#SBATCH --output=slurm_logs/job6_sg_joint_decl_long_%j.out
#SBATCH --error=slurm_logs/job6_sg_joint_decl_long_%j.err
#SBATCH --time=12:00:00

# ── Job 6: spectral_gating, joint fine-tuning, declarative_long control ──
