#!/bin/bash
#SBATCH --job-name=film_frozen_decl_long
#SBATCH --partition=goodarzilab_gpu_priority,gpu_batch_high_mem,gpu_batch
#SBATCH --gres=gpu:1
#SBATCH --mem=100G
#SBATCH --cpus-per-task=16
#SBATCH --output=slurm_logs/job8_film_frozen_decl_long_%j.out
#SBATCH --error=slurm_logs/job8_film_frozen_decl_long_%j.err
#SBATCH --time=12:00:00

# ── Job 8: film, frozen trunk, declarative_long control ──
