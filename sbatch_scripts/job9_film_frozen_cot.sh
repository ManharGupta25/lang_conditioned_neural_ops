#!/bin/bash
#SBATCH --job-name=film_frozen_cot
#SBATCH --partition=goodarzilab_gpu_priority,gpu_batch_high_mem,gpu_batch
#SBATCH --gres=gpu:1
#SBATCH --mem=100G
#SBATCH --cpus-per-task=16
#SBATCH --output=slurm_logs/job9_film_frozen_cot_%j.out
#SBATCH --error=slurm_logs/job9_film_frozen_cot_%j.err
#SBATCH --time=12:00:00

# ── Job 9: film, frozen trunk, cot_generated ──
